    ...
    private void getData() {
        ...
        client.get(Data. USERS + Data.TOKEN,new JsonHttpResponseHandler(){
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                try {
                    Toast.makeText(Perfil.this, errorResponse.getString("error"), Toast.LENGTH_SHORT).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    if (response.getString("message") != null){
                        Toast.makeText(Perfil.this,response.getString("message"),Toast.LENGTH_LONG ).show();
                        Perfil.this.finish();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
